        ...
        <div className="container mt-5 pb-5">
            ...
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body">
                            The life story video allows you to introduce yourself in a more personal and dynamic way than a traditional resume. It focuses on your experiences, values, passions, and unique aspects of your personality, helping others get to know you beyond your professional qualifications. Whether for networking, personal projects, or self-expression, it's a great way to connect with others on a deeper level.
                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body">
                            Simply sign up or log in to the platform, then click on "Create New Video." You'll be guided through a step-by-step process where you'll answer questions, upload media (like photos and videos), and customize your video to tell your story. You can include information about your personal journey, key life events, hobbies, or anything else that helps others understand who you are.                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingThree">
                        ...
                        >
                            Can I focus on specific aspects of my life in the video, such as personal achievements or passions?                        </button>
                    </h2>
                    <div
                    ...
                    >
                        <div className="accordion-body">
                            Absolutely! The beauty of the life story video is that it’s completely customizable. You can highlight the aspects of your life that matter most to you—whether it’s your family background, travel experiences, volunteer work, or personal milestones. The video is all about giving a holistic view of you as a person.                        </div>
                    </div>
                </div>
                ...
                <div className="accordion-item">
                    ...
                    >
                        <div className="accordion-body">
                            No, you don't need to be a video editing expert! The platform is designed to be user-friendly and intuitive. We provide templates, guided prompts, and built-in editing tools to help you create your video with ease. You can customize the video by adding text, music, and transitions without needing advanced skills.                        </div>
                    </div>
                </div>
                {/* שאלה 5 */}
                <div className="accordion-item">
